...
-- Selecionando dados das tabelas utilizando GROUP BY
SELECT
    t.nome              AS Tipo
...
-- Selecionando dados das tabelas utilizando Having
SELECT
    t.nome              AS Tipo
  , f.nome              AS Fabricante
  , SUM(p.quantidade)   AS Quantidade_em_Estoque 
...
-- Selecionando dados das tabelas utilizando Order By ASC
SELECT
    id
  , nome
  , id_fabricante
